...
<div class="container-xl px-4 mt-5">
    ...
    <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
        <div class="me-4 mb-3 mb-sm-0">
            ...
            <div class="small">
                <span class="fw-500 text-primary">{{ isset($lesson) ? 'Update Lesson' : 'Add New Lesson' }}</span>
            </div>
        </div>
    </div>
    <div class="card mb-4">
        <div class="card-header">{{ isset($lesson) ? 'Update Lesson' : 'Add New Lesson' }}</div>
        <div class="card-body">
            <form action="{{ isset($lesson) ? route('lesson.update', $lesson->id) :  route('lesson.create') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="inputTitle" type="text" placeholder="Enter Title" name="title" value="{{ isset($lesson) ? $lesson->title : '' }}" required />
                </div>
                <div class="mb-3">
                    <label for="inputDesc">Description</label>
                    <input class="form-control" id="inputDesc" type="text" placeholder="Enter Description" name="description" value="{{ isset($lesson) ? $lesson->description : '' }}" required />
                </div>
                <div class="mb-3">
